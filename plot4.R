...
png("plot4.png")
par(mfrow=c(2,2))
plot(pwr.data$DateTime, pwr.data$Global_active_power, type="l", xlab="", ylab="Global active power")
plot(pwr.data$DateTime, pwr.data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(pwr.data$DateTime, pwr.data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
